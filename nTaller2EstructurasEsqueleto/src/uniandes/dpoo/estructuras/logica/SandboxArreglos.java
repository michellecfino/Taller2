...
public class SandboxArreglos
{
    ...
    public void agregarEntero( int entero )
    {
        ...
        arregloEnteros = new int[copia.length + 1];
        for (int i = 0; i < copia.length; i++) {
            arregloEnteros[i] = copia[i];
        }
        arregloEnteros[copia.length] = entero;
    ...
    public void agregarCadena( String cadena )
    {
        ...
        arregloCadenas = new String[copia.length + 1];
        for (int i = 0; i < copia.length; i++) {
            arregloCadenas[i] = copia[i];
        }
        arregloCadenas[copia.length] = cadena;
    }
    ...
    public void eliminarEntero( int valor )
    {
        ...
        int[] nuevo = new int[arregloEnteros.length - c];
        int p = 0; 
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (arregloEnteros[i] != valor) {
                nuevo[p++] = arregloEnteros[i];
            }
        }
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        String[] nuevo = new String[arregloCadenas.length - c];
        int p = 0;
        for (int i = 0; i < arregloCadenas.length; i++) {
            if (!arregloCadenas[i].equalsIgnoreCase(cadena)) {
                nuevo[p++] = arregloCadenas[i];
            }
        }
    ...
    public void organizarCadenas( )
    {
        for (int i = 0; i < arregloCadenas.length - 1; i++) {
            for (int j = i + 1; j < arregloCadenas.length; j++) {
                if (arregloCadenas[i].compareToIgnoreCase(arregloCadenas[j]) > 0) {
    ...
    public int[] buscarEntero( int valor )
    {
        ...
        int[] buscado = new int[contador];
        for (int i = 0; i < contador; i++) {
            buscado[i] = posiciones[i];
        }
        return buscado;
    }
    /**
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int repetidos : histograma.values()) {
            if (repetidos > 1) {
                contador++;
            }
        }
