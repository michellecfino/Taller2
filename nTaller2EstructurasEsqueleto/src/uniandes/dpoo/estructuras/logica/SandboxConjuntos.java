...
public class SandboxConjuntos
{
	...
	public List<String> getCadenasComoLista( )
	{
		...
		for (String x: arbolCadenas.descendingSet()) {
			valores.add(x);
		};
	...
	{
		List<String> llaves = getCadenasComoLista();
		llaves.sort((a, b) -> b.compareTo(a)); // Ordena de mayor a menor
		return llaves;
	}
	...
	public String getPrimera( )
	{
		...
		if(arbolCadenas.isEmpty()) {
			...
			return getCadenasComoListaInvertida().getLast();
		}
	...
	public String getUltima( )
	{
		if(arbolCadenas.isEmpty()) {
			...
			return getCadenasComoListaInvertida().getFirst();
		}
	}
